...
DEVICE_NAME = "Microwave Sensor"
MAC_ADDRESS = "98:7B:F3:58:40:38"
DEVICE_TYPE = "NULL"
BLE_DELEGATE_HANDLE = [52]
HANDLE = [51, 55, 59, 63, 67]

MQTT_SERVER = "192.168.1.9"
MQTT_SUBSCRIBING_TOPIC = ["bean/microwave"]
VERBOSE = 1
...
class BLE_delegate(bluepy.btle.DefaultDelegate):
    ...
    def handleNotification(self, cHandle, data):
        ...
        self.client.publish(MQTT_SUBSCRIBING_TOPIC[0], self.binasciiToString(data))
